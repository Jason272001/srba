  ...
  const teamMembers = [
    {
      ...
      imgSrc: "https://via.placeholder.com/334x314",
    },
    {
      title: "Ms.",
      description:
      ...
      <div className="flex flex-col justify-center items-center gap-8 w-full">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 w-full h-full">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="group flex flex-col justify-center items-center gap-5 p-5 w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1rem)] transition-transform transform hover:scale-105"
            >
